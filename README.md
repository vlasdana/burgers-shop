...
```
cd existing_repo
git remote add origin https://git-iit.fh-joanneum.at/msd-webapp/ws23_students/vlas.git
git branch -M main
...
- [ ] [Set up project integrations](https://git-iit.fh-joanneum.at/msd-webapp/ws23_students/vlas/-/settings/integrations)
